...
export default function EarningsSection() {
  ...
  return (
    <section id="earnings" className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white border-t border-gray-100">
        
        <div className="p-8 md:p-14 border-b md:border-b-0 md:border-r-2 border-gray-100 flex flex-col justify-center text-center md:text-left">
          <span className="tag-black mb-4 inline-flex items-center gap-2">
            <LuActivity size={14} /> Ganancias estimadas
          </span>
          <div className="text-4xl md:text-6xl lg:text-7xl font-black text-night tracking-tighter leading-none mt-4">
            S/ {earnings.toLocaleString()}
            <span className="text-sm md:text-xl font-normal text-gray-400 tracking-normal block md:inline md:ml-3"> 
              por semana
            </span>
          </div>
          <p className="text-gray-400 text-sm md:text-base mt-3 mb-8">Basado en tarifas actuales en Lima, Perú</p>
          <div className="bg-gray-50 border-l-4 border-yellow px-5 py-4 text-xs text-gray-600 leading-relaxed rounded-r-xl">
            Calculamos las ganancias a partir de conductores activos en Lima durante las últimas 4 semanas.
                ...
                <div className="p-8 md:p-14 bg-gray-50/50 flex flex-col justify-center items-center md:items-start text-center md:text-left">
          ...
          <div className="bg-night rounded-2xl p-6 md:p-8 shadow-xl shadow-night/20 w-full">
            <p className="text-yellow text-xs md:text-sm font-black uppercase tracking-[0.2em] mb-5 flex items-center gap-2 justify-center md:justify-start">
      ...
      <div id="how" className="bg-night px-6 md:px-14 py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center md:text-left">
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white tracking-tight mt-4 mb-4">
            Simple como <span className="text-yellow">1, 2, 3</span>
          </h2>
          <p className="text-gray-500 text-base md:text-lg mb-12 max-w-md mx-auto md:mx-0">
