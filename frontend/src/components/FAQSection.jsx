  ...
  return (
    <div className="faq-item" onClick={() => setOpen(!open)}>
      <div className="faq-row">
        <span className="faq-question pr-4">{q}</span>
        <span className={`faq-icon flex-shrink-0 ${open ? 'rotate-45' : ''}`}>+</span>
      </div>
...
export default function FAQSection() {
  return (
    <section>
      ...
      <div className="bg-white px-6 md:px-14 py-12 md:py-14">
        <h2 className="text-3xl md:text-4xl font-black text-night tracking-tight mb-7">
      ...
      {/* CTA — 1 col mobile, 2 col desktop */}
      <div className="grid grid-cols-1 md:grid-cols-2">

        <div className="bg-yellow px-6 md:px-14 py-12 md:py-16 flex flex-col justify-center">
          <span className="tag-black mb-5 w-fit">La app</span>
          <h2 className="text-3xl md:text-4xl font-black text-night tracking-tight mb-3">
        ...
        <div className="bg-night-2 flex items-center justify-center px-6 md:px-12 py-12">
