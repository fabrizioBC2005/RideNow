  ...
  return (
    <section id="requirements" className="w-full">
      <div className="bg-white px-6 md:px-14 pt-16 pb-12">
        <h2 className="text-4xl md:text-5xl font-black text-night tracking-tight mb-2">
          Qué necesitas para registrarte
        </h2>
        <p className="text-gray-400 mb-8 font-medium">Rápido, todo en línea, sin filas.</p>

        <div className="flex gap-8 border-b-2 border-gray-100 mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
          {REQ_COLS.map((col) => (
            <div key={col.num} className="flex flex-col group">
              ...
              <h3 className="text-xl font-bold text-night mb-6">{col.title}</h3>
              ...
              <a href="/register" className="flex items-center gap-2 text-xs font-black uppercase tracking-wider text-night hover:text-yellow transition-colors group/link">
                {col.link} 
      ...
      <div id="safety" className="bg-night px-6 md:px-14 py-20 md:py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {SAFETY.map((s) => (
              <div key={s.title} className="bg-white/[0.03] border border-white/5 p-8 rounded-[2rem] hover:bg-white/[0.06] transition-all">
