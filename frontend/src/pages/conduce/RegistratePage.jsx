  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      */
      ...
      setErrors({
        server: "Hubo un problema con el servidor. Inténtalo más tarde.",
      });
    } finally {
    ...
    <>
      ...
      <div className="px-4 sm:px-6 md:px-10 py-10 md:py-14 max-w-7xl mx-auto">
        ...
        <p className="text-gray-600 mb-10 max-w-2xl text-center md:text-left text-sm md:text-base">
          Completa tu información y empieza a generar ingresos conduciendo con
          RideNow.
        </p>
              ...
              <ul className="flex flex-col gap-5 text-gray-200 text-sm md:text-base">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-white">
                      Maneja en tus horarios
                    </p>
                    <p className="text-xs text-gray-400">
                      Tú decides cuándo y cuánto tiempo deseas conectarte.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      Recibe tus ganancias directo en tu cuenta bancaria de
                      forma segura.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      Multiplica tus ingresos completando las misiones y metas
                      semanales.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-white">
                      Mayor demanda en Lima
                    </p>
                    <p className="text-xs text-gray-400">
                      Accede a las zonas de alta tarifa dinámica para asegurar
                      viajes seguidos.
                    </p>
                  </div>
                </li>
