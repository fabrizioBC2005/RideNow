      ...
      <div className="px-4 sm:px-6 md:px-10 py-10 md:py-14 max-w-7xl mx-auto">
        <div className="text-center md:text-left mb-10">
          ...
          <p className="text-gray-600 max-w-2xl text-sm md:text-base mx-auto md:mx-0">
            Para registrarte como conductor en RideNow debes cumplir con los
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className={cardStyle}>
            ...
            <p className="text-gray-600 text-sm md:text-base pl-1">
              Debes contar con una licencia de conducir válida y sin sanciones
              vigentes.
            </p>
          </div>
          ...
          <div className={cardStyle}>
            ...
            <p className="text-gray-600 text-sm md:text-base pl-1">
              Auto de 4 puertas con revisión técnica y mantenimiento mecánico al
              día.
            </p>
          </div>
          ...
          <div className={cardStyle}>
            ...
            <p className="text-gray-600 text-sm md:text-base pl-1">
              DNI vigente, SOAT (físico o electrónico) y tarjeta de propiedad
              del auto.
            </p>
          </div>
          ...
          <div className={cardStyle}>
            ...
            <p className="text-gray-600 text-sm md:text-base pl-1">
              Necesitas un smartphone (Android o iOS) con datos activos para
              operar la app.
            </p>
          </div>
          ...
          <div className={cardStyle}>
            ...
            <p className="text-gray-600 text-sm md:text-base pl-1">
              Una cuenta a tu nombre para recibir tus transferencias y bonos
              semanales.
            </p>
          </div>
          ...
          <div className={cardStyle}>
            ...
            <p className="text-gray-600 text-sm md:text-base pl-1">
              Debes tener al menos 18 años cumplidos para registrarte de manera
              legal.
            </p>
          </div>
        </div>
