...
export default function LoginPage() {
  ...
  return (
    <>
      <Navbar />
      <main className="bg-blue-100 min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-[400px] bg-[#111] border border-white/5 rounded-[2rem] p-8 md:p-10 shadow-2xl">
          ...
          <p className="text-center mt-8 text-[10px] text-gray-600 font-bold uppercase tracking-widest">
            ¿Nuevo aquí? <a href="/register" className="text-white hover:text-yellow underline underline-offset-4 ml-1">Crea una cuenta</a>
          </p>
        </div>
      </main>
      <Footer />
